...
#Parse json response and extract the sunset time, adding the systemcs utc offset to obtain the local time of the sunset
...
#Create 'at' job on local linux box to switch relay on
system"echo 'curl http://relay.home/on' | at #{offTime.strftime('%H:%M')}"
